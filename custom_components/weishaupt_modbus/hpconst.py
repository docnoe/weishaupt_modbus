...
MODBUS_SYS_ITEMS: list[ModbusItem] = [
    ModbusItem( address=30001, name="Aussentemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR, device=DEVICES.SYS, params=PARAMS_STDTEMP, translation_key="aussentemp"),
    ModbusItem( address=30002, name="Luftansaugtemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR, device=DEVICES.SYS, params=PARAMS_STDTEMP, translation_key="luftansautgemp"),
    ModbusItem( address=30003, name="Fehler", mformat=FORMATS.STATUS, mtype=TYPES.SENSOR, device=DEVICES.SYS, resultlist=SYS_FEHLER, params=PARAMS_ALERT, translation_key="fehler"),
...
MODBUS_WP_ITEMS: list[ModbusItem] = [
    ...
    ModbusItem( address=33104, name="Vorlauftemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR, device=DEVICES.WP, params=PARAMS_STDTEMP, translation_key="vl_temp"),
    ModbusItem( address=33105, name="Rücklauftemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR,  device=DEVICES.WP, params=PARAMS_STDTEMP, translation_key="rl_temp"),
    ModbusItem( address=33106, name="Verdampfungstemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR, device=DEVICES.WP, params=PARAMS_STDTEMP, translation_key="verdampfungs_temp"),
    ModbusItem( address=33107, name="Verdichtersauggastemp", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR, device=DEVICES.WP, params=PARAMS_STDTEMP, translation_key="verdichter_ansaug_gas_temp"),
    ModbusItem( address=33108, name="Weichentemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR, device=DEVICES.WP, params=PARAMS_STDTEMP, translation_key="weichen_temp"),
    ...
    ModbusItem( address=43104, name="Sollwert Pumpe Leistung Heizen", mformat=FORMATS.PERCENTAGE, mtype=TYPES.NUMBER_RO, device=DEVICES.WP, params=PARAMS_PERCENTAGE, translation_key="sollwert_pumpe_leistung_heizen"),
...
MODBUS_HZ_ITEMS = [
    ...
    ModbusItem( address=41110, name="Heizen Konstanttemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.NUMBER, device=DEVICES.HZ, params=PARAMS_ROOMTEMP, translation_key="heiz_konstanttemp"),
    ModbusItem( address=41111, name="Heizen Konstanttemp Absenk", mformat=FORMATS.TEMPERATURE, mtype=TYPES.NUMBER, device=DEVICES.HZ, params=PARAMS_ROOMTEMP, translation_key="heiz_konstanttemp_absenk"),
...
MODBUS_WW_ITEMS: list[ModbusItem] = [
    ModbusItem( address=32101, name="Warmwassersolltemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.SENSOR, device=DEVICES.WW, params=PARAMS_WATERTEMP, translation_key="ww_soll_temp"),
...
MODBUS_W2_ITEMS: list[ModbusItem] = [
   ...
   # This is always 0. Error of weishaupt on modbus. The modbus documentation is wrong.
    ...
    ModbusItem( address=44104, name="Grenztemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.NUMBER, device=DEVICES.W2, params=PARAMS_BIVALENZTEMP, translation_key="grenztemp"),
    ModbusItem( address=44105, name="Bivalenztemperatur", mformat=FORMATS.TEMPERATURE, mtype=TYPES.NUMBER, device=DEVICES.W2, params=PARAMS_BIVALENZTEMP, translation_key="bivalenztemp"),
    ModbusItem( address=44106, name="Bivalenztemperatur WW", mformat=FORMATS.TEMPERATURE, mtype=TYPES.NUMBER, device=DEVICES.W2, params=PARAMS_BIVALENZTEMP, translation_key="bivalenztemp_ww"),
]
